...
The classic card agme also known as 21. (This version doesn't have
...
def main():
    ...
    Rules:
        ...
        but must hir exactly one more time before standing.
        In case of a tie, the bet is returned to the player.
        The dealer stops hitting at 17.''')

    money = 5000
    while True: # Main game loop.
        # Check if the player run out of money:
        if money <= 0:
            print("You're broke!")
