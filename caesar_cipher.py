...
print('key number. For example, a key of 2 meaans the letter A is')
...
# Let the user enter the message to ecnrypt/decrypt:
...
# Encrypt/decrypt each symbol in the mmessage:
